      ...
      if (client.available()) {
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.println("<!DOCTYPE html><html><head><title>SHAMIRAH APPLIANCES</title>");
            ...
            client.println("<h1>SHAMIRAH APPLIANCES</h1>");
            ...
            client.println("</div>");
            client.println("<footer>&copy; SHAMIRAH APPLIANCES | Team Innovators</footer>");
